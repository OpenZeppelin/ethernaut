...
&nbsp;
#### 6. Get test ether
To play the game, you will need test ether. The easiest way to get some testnet ether is via [this faucet](https://faucet.paradigm.xyz/) or [this faucet](https://faucet.rinkeby.io/).
